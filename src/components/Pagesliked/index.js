...
import $ from "jquery";
class Pagesliked extends React.Component { 
    constructor(props)
    {
      super(props);
      this.state = {
    ...
    <div className="sidbar_left">
        <i className="fas fa-times side_b close"  onClick={this.openClose.bind(this)}></i>
                    ...
                    <ul>
                        ...
                        <li><Link to="pagesliked" className="active"><span><img src="images/iconS7.png" align="icon"/></span> Pages Liked</Link></li>
