    ...
    componentDidMount() {
        ...
        .then((response1) => {
            if(response1.data.status = 'data'){
                this.setState({friendsrequests: response1.data.message});
            }else{
    ...
    <div className="sidbar_left">
        <i className="fas fa-times side_b close"  onClick={this.openClose.bind(this)}></i>
                ...
                <ul>
                    ...
                    <li><Link to="/requests" className="active"><span><img src="images/iconS3.png" align="icon"/></span> Requests</Link></li>
            ...
            <div className="in_center in_center_discussion">
                ...
                <div className="my_followers">
                    ...
                    <div className="row">
                        { this.state.friendsrequests && this.state.friendsrequests.length > 0 ? this.state.friendsrequests.map((resultf, i) => {
                            return (
